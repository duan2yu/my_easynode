...
(function () {
        ...
        class Main extends GenericObject {
                ...
                static main() {
                        return function * () {
                                logger.info('initializing project [ydgps.web]...');
                                var koaHttpServer = BeanFactory.get('httpServer');
                                koaHttpServer.addWebDirs('projects/ydgps/sub-systems/web/www/');
                                ...
                                var plugin = using('easynode.framework.plugin.Plugins');
                                yield plugin.load();
