...
(function () {
        /**
         * Class CBB100Message0x0202
         *
         * @class szzh.cbb100.protocol.messages.CBB100Message0x0202
         * @extends szzh.cbb100.protocol.messages.CBB100Message
         * @since 0.1.0
         * @author zlbbq
         * */
        class CBB100Message0x0202 extends CBB100Message {
                /**
                 * 构造函数。
                 *
                 * @method 构造函数
                ...
                convert(msg, client) {
                        msg[CBB100Message0x0202.ALARM_ATTRS[msg['alarmType']]] = msg['alarmState'];
                        var lat, lng;
                        ...
                        msg['deviceTime'] = CBB100Message0x0202.clientTime2String(buf);
        ...
        CBB100Message0x0202.ALARM_DOOR_OPENED = 0x00;
        CBB100Message0x0202.ALARM_MOVEMENT = 0x01;
        CBB100Message0x0202.ALARM_QUAKE = 0x02;
        CBB100Message0x0202.ALARM_SPEEDY = 0x03;
        CBB100Message0x0202.ALARM_POWER_OFF = 0x04;
        CBB100Message0x0202.ALARM_ATTRS = ['alarmDoorOpened', 'alarmMovement', 'alarmQuake', 'alarmSpeedy','alarmPowerOff'];

        module.exports = CBB100Message0x0202;
})();