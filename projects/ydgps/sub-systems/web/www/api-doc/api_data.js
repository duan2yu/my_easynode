define({ "api": [
  ...
  {
    "type": "post",
    "url": "/api/deviceGroup/updateDevice/:deviceGroupId",
    "title": "更新设备分组和设备绑定关系",
    "name": "updateDevice",
    "group": "DeviceGroup",
    "parameter": {
  ...
  {
    "type": "post",
    "url": "/api/device/config/g2ReportTime/:deviceId",
    "title": "g2设备定时上报",
    "name": "g2ReportTime",
    "group": "Device",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "g2KeepOnline",
            "description": "<p>CBB-100G2设备专用参数，持续时间 单位分钟</p> "
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/api/electronic-fence/toggle/:efId/:flag",
    "title": "启用/禁用电子围栏功能",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "flag",
            "description": "<ul> <li>启用/停用标识, &quot;enabled&quot;/&quot;disabled&quot;</li> </ul> "
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/api/user/bindDeviceGroup/:userId",
    "title": "用户绑定设备分组(覆盖原有绑定关系)",
    "name": "bindDeviceGroup",
    "group": "User",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "deviceGroupId",
            "description": "<ul> <li>分组列表，多个ID使用&quot;,&quot;分隔</li> </ul> "
          }
        ]
      }
    },
