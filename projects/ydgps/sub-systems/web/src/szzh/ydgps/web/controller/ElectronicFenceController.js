...
(function () {
        ...
        class ElectronicFenceController extends GenericObject {
                              ...
                              //  if(this.validator.isValid()) {
                                        ...
                                        try {
                                                ...
                                                ret = yield me.bookshelf.knex('electronic_fence_devices')
                                                        ...
                                                        .where({
                                                                efId: efId
                                                        }).transacting(tran).select('motor_device.imei');
                ...
                /**
                 * @api {post} /api/electronic-fence/toggle/:efId/:flag 启用/禁用电子围栏功能
                 * @apiName toggleDeviceElectronicFence
                 * @apiGroup ElectronicFence
                 *
                 * @apiParam {String} imei * 电子围栏id
                ...
                toggleDeviceEF() {
                        ...
                        return function * () {
                                ...
                                if(flag != 'enabled' && flag != 'disabled') {
                                        return ActionResult.createValidateFailResult('非法的toggle状态，只能是enabled/disabled');
                                }
                                yield me.bookshelf.knex('electronic_fence')
                                        .where('id', efId)
                                        .update({
                                                'electronic_fence.state' : this.p('flag') == 'enabled' ? '1' : '0'
                                        });
