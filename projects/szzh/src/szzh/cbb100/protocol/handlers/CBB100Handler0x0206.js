...
(function () {
        /**
         * Class CBB100Handler0x0206
         *
         * @class szzh.cbb100.protocol.handlers.CBB100Handler0x0206
         * @extends szzh.cbb100.protocols.handlers.CBB100AbstractHandler
         * @since 0.1.0
         * @author zlbbq
         * */
        class CBB100Handler0x0206 extends CBB100AbstractHandler {
                /**
                 * 构造函数。
                 *
                 * @method 构造函数
                ...
                handleMessage(msg) {
                        var me = this;
                        return function * () {
                                me.client.deviceData(msg, '0x0206');
                                var message = CBB100Message.createMessageById(0x0206);
        ...
        module.exports = CBB100Handler0x0206;
})();