...
(function () {
        /**
         * Class CBB100Message0x0210
         *
         * @class szzh.cbb100.protocol.messages.CBB100Message0x0210
         * @extends szzh.cbb100.protocol.messages.CBB100Message
         * @since 0.1.0
         * @author zlbbq
         * */
        class CBB100Message0x0210 extends CBB100Message {
                /**
                 * 构造函数。
                 *
                 * @method 构造函数
                ...
                getStructDescription(msg) {
                        return [
                                'efAlarmType:BYTE',                                                  //区域报警类型
                                'efType:BYTE',                                                             //区域类型
                                'efId:DWORD',                                                             //区域ID
                                'efDirection:BYTE',                                                     //方向：０：进入区域，１：离开区域
                                'reversed_0x0210:BYTES:20',                                  //保留
                ...
                convert(msg, client) {
                        ...
                        msg['deviceTime'] = CBB100Message0x0210.clientTime2String(buf);
        ...
        module.exports = CBB100Message0x0210;
})();